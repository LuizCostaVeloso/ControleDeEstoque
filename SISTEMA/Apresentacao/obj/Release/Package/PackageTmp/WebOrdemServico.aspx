<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaPrincipal.Master" AutoEventWireup="true" CodeBehind="WebOrdemServico.aspx.cs" Inherits="Apresentacao.WebOrdemServico" %>
                ...
                <div class="form-group col-md-3 pull-right">
                    <div class="input-group">
                        <span class="input-group-addon" style="padding: 1px 4px; font-size: 16px;">
                            <asp:DropDownList ID="ddlTipoBusca" runat="server" class="form-control" Width="150px" Style="font-size: 16px; height: 25px; padding: 2px 4px;">
                ...
                <div class=" scroll-grid col-md-12">
                    <asp:GridView ID="gvListaOS" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="gvListaOS_SelectedIndexChanged"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Data de Início" HeaderText="Data de Início" ItemStyle-HorizontalAlign="Center" />
                    ...
                    <div class="row ">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <div id="divDataFinalizacao" runat="server">
                                ...
                                <span class="input-group-addon" style="padding: 0px 10px;" id="spanLimparFinalizacao" runat="server">
                                    <asp:LinkButton ID="btnLimparDataFinalizacao" runat="server" OnClick="btnLimparDataFinalizacao_Click">
                                        <i><span class="input-group-addon" style="padding: 0px; border: 0;">
                                            <img src="img/vassoura.png" /></span></i>
                                    </asp:LinkButton>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <%--<div class="row">
                                <div class="col-md-5 pull-right">
                                    <!-- Text input-->
                                    <div class="form-group">
                                        <label class="control-label" for="txtTotalProdutoColuna">Total de Produto:</label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span></span>
                        ...
                        <div class="col-md-6">
                            ...
                            <%--  <div class="row">
                                <div class="col-md-5 pull-right">
                                    <!-- Text input-->
                                    <div class="form-group">
                                        <label class="control-label" for="txtTotalServicoColuna">Total de Serviços:</label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span></span>
