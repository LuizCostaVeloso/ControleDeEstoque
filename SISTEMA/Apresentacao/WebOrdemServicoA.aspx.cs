...
{
    public partial class WebOrdemServicoA : System.Web.UI.Page
    {
     /// <summary>
        ...
        {           
            ...
            {                
                ...
                if (objFuncionario._Cargo == caixa)
                {
                    Response.Redirect("WebOrdemServicoC.aspx");
                }                 
                else if (objFuncionario._Cargo == atendente)
                {
        ...
        /// <param name="sender">Objeto do evento</param>
        /// <param name="e">Evento</param>
        protected void btnLimparFinalizacao_Click(object sender, EventArgs e)
        {
            txtDataFinalizacao.Text = "";
        }
        #endregion
