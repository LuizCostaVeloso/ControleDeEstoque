...
namespace Apresentacao.DataSet1TableAdapters {
    ...
    public partial class ProdutoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Produto] WHERE (([produtoID] = @Original_produtoID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Produto] ([nomeProduto], [nomeFornecedor], [estoqueMinimo], [estoque" +
                "], [precoCompra], [precoVenda], [telefoneFornecedor]) VALUES (@nomeProduto, @nom" +
                "eFornecedor, @estoqueMinimo, @estoque, @precoCompra, @precoVenda, @telefoneForne" +
                "cedor)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Produto] SET [nomeProduto] = @nomeProduto, [nomeFornecedor] = @nomeFornecedor, [estoqueMinimo] = @estoqueMinimo, [estoque] = @estoque, [precoCompra] = @precoCompra, [precoVenda] = @precoVenda, [telefoneFornecedor] = @telefoneFornecedor WHERE (([produtoID] = @Original_produtoID))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["SICSEPConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT produtoID, nomeProduto, nomeFornecedor, estoqueMinimo, estoque, precoCompr" +
                "a, precoVenda, telefoneFornecedor\r\nFROM     Produto";
